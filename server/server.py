...
app.config["AZURE_VOICE_NAME"] = os.getenv("AZURE_VOICE_NAME", "es-ES-Ximena:DragonHDLatestNeural")
app.config["AZURE_AGENT_PROJECT_NAME"] = os.getenv("AZURE_AGENT_PROJECT_NAME")
app.config["AZURE_AGENT_NAME"] = os.getenv("AZURE_AGENT_NAME")
